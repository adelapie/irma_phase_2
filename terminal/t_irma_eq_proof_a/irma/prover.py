...
def proveEQ_RevealAll(connection, pk_i_1, CRED_ID_1, pk_i_2, CRED_ID_2, DEBUG): 
  
  NONCE_1 = irma_util.gen_nonce(LEN_NONCE_BITS, 1)
  NONCE_2 = irma_util.gen_nonce(LEN_NONCE_BITS, 1)
  ...
  (t, r, n) = irma_util.send_apdu(connection, CMD_PROVE_CREDENTIAL + CRED_ID_1 + CRED_SEL + CONTEXT + TIME_STAMP)
  irma_util.print_details(DEBUG, CMD_PROVE_CREDENTIAL + CRED_ID_1 + CRED_SEL + CONTEXT + TIME_STAMP, r, t, n)

  if DEBUG:    
    print "INS_PROVE_COMMITMENT"

  (t, r, n) = irma_util.send_apdu(connection, CMD_PROVE_COMMITMENT + LEN_PC + NONCE_2)
  irma_util.print_details(DEBUG, CMD_PROVE_COMMITMENT + LEN_PC + NONCE_2, r, t, n)
  ...
  (t, r, n) = irma_util.send_apdu(connection, CMD_GET_A_X)
  irma_util.print_details(DEBUG, CMD_GET_A_X, r, t, n)

  data, sw1, sw2 = r
  aX = irma_util.APDU2integer(data) 

  if DEBUG:  
    print "INS_GET_V (2)"

  (t, r, n) = irma_util.send_apdu(connection, CMD_GET_V_X)
  irma_util.print_details(DEBUG, CMD_GET_V_X, r, t, n)

  data, sw1, sw2 = r
  vX = irma_util.APDU2integer(data) 

  if DEBUG:  
    print "INS_GET_E (2)"

  (t, r, n) = irma_util.send_apdu(connection, CMD_GET_E_X)
  irma_util.print_details(DEBUG, CMD_GET_E_X, r, t, n)

  data, sw1, sw2 = r
  eX = irma_util.APDU2integer(data) 
   
  if DEBUG:
    print "INS_GET_ATTR (2) (m1)"

  (t, r, n) = irma_util.send_apdu(connection, CMD_GET_ATTR_1_2)
  irma_util.print_details(DEBUG, CMD_GET_ATTR_1_2, r, t, n)

  data, sw1, sw2 = r
  m1_2 = irma_util.APDU2integer(data)

  if DEBUG:
    print "INS_GET_ATTR (2) (m2)"

  (t, r, n) = irma_util.send_apdu(connection, CMD_GET_ATTR_2_2)
  irma_util.print_details(DEBUG, CMD_GET_ATTR_2_2, r, t, n)

  data, sw1, sw2 = r
  m2_2 = irma_util.APDU2integer(data)

  if DEBUG:
    print "INS_GET_ATTR (2) (m3)"

  (t, r, n) = irma_util.send_apdu(connection, CMD_GET_ATTR_3_2)
  irma_util.print_details(DEBUG, CMD_GET_ATTR_3_2, r, t, n)

  data, sw1, sw2 = r
  m3_2 = irma_util.APDU2integer(data)

  if DEBUG:
    print "INS_GET_ATTR (2) (m4)"

  (t, r, n) = irma_util.send_apdu(connection, CMD_GET_ATTR_4_2)
  irma_util.print_details(DEBUG, CMD_GET_ATTR_4_2, r, t, n)

  data, sw1, sw2 = r
  m4_2 = irma_util.APDU2integer(data)

  if DEBUG:
    print "INS_GET_ATTR (2) (m5)"

  (t, r, n) = irma_util.send_apdu(connection, CMD_GET_ATTR_5_2)
  irma_util.print_details(DEBUG, CMD_GET_ATTR_5_2, r, t, n)

  data, sw1, sw2 = r
  m5_2 = irma_util.APDU2integer(data)
  ...
  proof = { 'c':c, 
            'n32':irma_util.APDU2integer(NONCE_2), 
            'pAprime1':a, 
            'pAprime2':aX, 
            'pEhat1':e, 
            'pEhat2':eX, 
  ...
  m_c_1 = { '1':m1, '2':m2, '3':m3, '4':m4, '5':m5 }
  m_c_2 = { '1':m1_2, '2':m2_2, '3':m3_2, '4':m4_2, '5':m5_2 }
    
  cred1 = {'m':m_c_1 }
  cred2 = {'m':m_c_2 }
  
  verifier = protocol_ibm12.Verifier(pk_i_1, irma_util.APDU2integer(CONTEXT))

  return (data, sw1, sw2, verifier.verifyEqAll2_IRMA_FORTUNA(cred1, cred2, pk_i_1, pk_i_2, proof))

def proveEQ_HideAll(connection, pk_i_1, CRED_ID_1, pk_i_2, CRED_ID_2, DEBUG): 
  ...
  (t, r, n) = irma_util.send_apdu(connection, CMD_PROVE_CREDENTIAL + CRED_ID_1 + CRED_SEL_HIDE + CONTEXT + TIME_STAMP)
  irma_util.print_details(DEBUG, CMD_PROVE_CREDENTIAL + CRED_ID_1 + CRED_SEL_HIDE + CONTEXT + TIME_STAMP, r, t, n)
  ...
  if DEBUG:
    print "INS_GET_ATTR (2) (ms)"

  (t, r, n) = irma_util.send_apdu(connection, CMD_GET_ATTR_0_2)
  irma_util.print_details(DEBUG, CMD_GET_ATTR_0_2, r, t, n)

  data, sw1, sw2 = r
  ms_2 = irma_util.APDU2integer(data)
  ...
  proof = { 'c':c, 
            'n31':irma_util.APDU2integer(NONCE_1 + NONCE_2), 
            'n32':irma_util.APDU2integer(NONCE_2), 
            'pAprime1':a, 
            'pAprime2':aX, 
            'pEhat1':e, 
  ...
  return (data, sw1, sw2, verifier.verifyEqAll2_IRMA_H(cred1, cred2, pk_i_1, pk_i_2, proof))



def proveEQ_HideAll_TEST(connection, pk_i_1, CRED_ID_1, pk_i_2, CRED_ID_2, DEBUG): 
