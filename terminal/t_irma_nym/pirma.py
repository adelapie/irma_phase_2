...
if __name__ == '__main__':
  ...
  print "Rnym", toHexString(irma_util.int2APDU(int(Rnym)))
  print "Rr", toHexString(irma_util.int2APDU(int(Rr)))
  print "Rdom", toHexString(irma_util.int2APDU(int(Rdom)))
  print "Gamma", toHexString(irma_util.int2APDU(int(Gamma)))
  
  (c1, c2) = issuer.issueCredentialX(connection, pk_i_1, sk_i_1, m_student_1, [0x00, 0x01], 0)
  print "Issuing root credential:", c1, c2
 
  #(t, r, n, ok_prove) = prover.proveCommitmentNYM_ONLY(connection, pk_i_1, [0x00, 0x01], 1, Rdom, Rr, r1)
  #print "Verifying CRED #1:", ok_prove

  (t, r, n, ok_prove) = prover.proveCommitmentNYM_ONLY_H(connection, pk_i_1, [0x00, 0x01], 1, Rdom, Rr, r1)
  print "Verifying CRED #1:", ok_prove
