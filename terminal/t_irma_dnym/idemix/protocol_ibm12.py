...
class Issuer:
  ...
  def roundNumber2(self, U, attr, n2):
    ...
    #print "attr issuer round 2", attr['1']

    #Q_tmp = (self.pk_i['Z']/((self.pk_i['S'] ** vPrimePrime) * U * Cx)) % self.pk_i['N']

    #print "CHECK THIS:", Q_tmp
    # OK, Q_tmp a mano = automatizado con pksigCL03

    #print "#1 vPrimePrime", vPrimePrime
...
class Recipient:
  ...
  def roundNumber3(self, signature, P2, n2):    
    ...
    # TODO: 
    # 1. check that e is prime
    # 2. check e is within a certain limit 

    #print "recipient Q2, attr:", self.all

    #print "SELF.ALL #2:", self.all

    Q2 = (self.pk_i['Z']/((self.pk_i['S'] ** v) * self.all)) % self.pk_i['N']

    #print "CHECK THIS, vPrimePrime", vPrimePrime
    #print "CHECK THIS, vPrime", self.vPrime
    ...
    #print "Q2 1 vez", Q2
    #print "Q2 a mano", Q22
    #print "attr recipient round 3", self.ak
    
    #print "Recipient, U, round3", tmp_u
    ...
    #print "recipient Q2", Q2
    #print "recipient A", A
    #print "recipient n2", n2
    #print "recipient Ahat", Ahat
...
class Verifier:
  ...
  def verifyAllIRMA_NYM(self, m, input):
  ...
  def verifyAllIRMA_NYM_H(self, m, input):
      pAprime = input['pAprime']
      pChat = input['pChat']
      pEhat = input['pEhat']
      mHatMs = input['mHatMs']
      ...
      That1 = (self.pk_i['Z'] / (Ak * (pAprime ** (2 ** (le - 1))))) ** ((-1 * pChat)) % self.pk_i['N']
      That2 = (pAprime ** pEhat) * (self.pk_i['Ro'] ** mHatMs) * (R['2'] ** m['2']) * (R['3'] ** m['3']) * (R['4'] ** m['4']) * (R['5'] ** m['5']) * (self.pk_i['S'] ** pVprimeHat) % self.pk_i['N']
