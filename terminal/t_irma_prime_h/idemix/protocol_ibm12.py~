...
class Verifier:
  ...
  def verifyAllIRMA(self, m, input):
      ...
      list_ints = []
      list_ints.append(int(self.context))
      list_ints.append(int(pAprime))
      list_ints.append(int(That))
      list_ints.append(int(n3))
                  
      ber_context =  univ.Integer(self.context)
      ber_pAprime = univ.Integer(pAprime)
      ber_That = univ.Integer(That)
      ber_n3 = univ.Integer(n3)
  ...
  def verifyHideAllIRMA(self, m, input):
      pAprime = input['pAprime']
      pChat = input['pChat']
      pEhat = input['pEhat']
      mHatMs = input['mHatMs']
