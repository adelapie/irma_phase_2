    ...
    switch (INS) {
      ...
      case INS_PROVE_ATTRIBUTE:
        ...
        /* Cases (per length)
          ...
          unsigned char euclid_b[] = {0x00, 0x00, 0x00, 0x00, 0x01, 0xf1, 0xd3, 0x6b, 0xfb};
          unsigned char euclid_a[] = {0x06, 0x02, 0x64, 0x75, 0xbf, 0x3b, 0x86, 0x00, 0x00};

          unsigned char euclid_b[] = {0x00, 0x00, 0x00, 0x41, 0xea, 0x5f};
          unsigned char euclid_a[] = {0x55, 0x6a, 0x82, 0xf6, 0x49, 0x61};

          unsigned char euclid_a[] = {0x00, 0x00, 0x00, 0x03};
          unsigned char euclid_b[] = {0x47, 0x2f, 0xf1, 0x71};

          unsigned char euclid_a[] = {0x00, 0x03};
          unsigned char euclid_b[] = {0x13, 0x8d};
        
        */

          unsigned char a[] = {0x00, 0x00, 0x00, 0x00, 0x01, 0xf1, 0xd3, 0x6b, 0xfb};
          unsigned char b[] = {0x06, 0x02, 0x64, 0x75, 0xbf, 0x3b, 0x86, 0x00, 0x00};
