...
void generateXY(unsigned char *input_1, unsigned char *input_2) {
  unsigned char amount = 0x00;
  
  unsigned char n_1[GCD_MAX_SIZE_2];
  unsigned char n_2[GCD_MAX_SIZE_2];
  
  Copy(GCD_MAX_SIZE_2, n_1, input_1);
  Copy(GCD_MAX_SIZE_2, n_2, input_2);
  
  switch(input_1[0] >> 4) { // obtain upper nibble
    case 0x00:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_0 & 0xff, n_1, n_2);
      break;
    case 0x01:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_1 & 0xff, n_1, n_2);
      break;
    case 0x02:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_2 & 0xff, n_1, n_2);
      break;
    case 0x03:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_3 & 0xff, n_1, n_2);
      break;
    case 0x04:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_4 & 0xff, n_1, n_2);
      break;
    case 0x05:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_5 & 0xff, n_1, n_2);
      break;
    case 0x06:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_6 & 0xff, n_1, n_2);
      break;
    case 0x07:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_7 & 0xff, n_1, n_2);
      break;
    case 0x08:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_8 & 0xff, n_1, n_2);
      break;
    case 0x09:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_9 & 0xff, n_1, n_2);
      break;
    case 0x0a:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_A & 0xff, n_1, n_2);
      break;
    case 0x0b:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_B & 0xff, n_1, n_2);
      break;
    case 0x0c:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_C & 0xff, n_1, n_2);
      break;
    case 0x0d:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_D & 0xff, n_1, n_2);
      break;
    case 0x0e:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_E & 0xff, n_1, n_2);
      break;
    case 0x0f:
      multosBlockShiftRight(GCD_MAX_SIZE_2, N_BITS_F & 0xff, n_1, n_2);
      break;
  }

  Copy(GCD_MAX_SIZE_2, input_2, n_2);
}
...
void generateXY_long(unsigned char *input_1, unsigned char *input_2) {
  ...
  unsigned char n_1[GCD_MAX_SIZE_2*2];
  unsigned char n_2[GCD_MAX_SIZE_2*2];
  
  Copy(GCD_MAX_SIZE_2*2, n_1, input_1);
  Copy(GCD_MAX_SIZE_2*2, n_2, input_2);
  
  switch(input_1[0] >> 4) { // obtain upper nibble
    case 0x00:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_0_LONG & 0xff), n_1, n_2);
      break;
    case 0x01:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_1_LONG & 0xff), n_1, n_2);
      break;
    case 0x02:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_2_LONG & 0xff), n_1, n_2);
      break;
    case 0x03:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_3_LONG & 0xff), n_1, n_2);
      break;
    case 0x04:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_4_LONG & 0xff), n_1, n_2);
      break;
    case 0x05:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_5_LONG & 0xff), n_1, n_2);
      break;
    case 0x06:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_6_LONG & 0xff), n_1, n_2);
      break;
    case 0x07:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_7_LONG & 0xff), n_1, n_2);
      break;
    case 0x08:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_8_LONG & 0xff), n_1, n_2);
      break;
    case 0x09:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_9_LONG & 0xff), n_1, n_2);
      break;
    case 0x0a:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_A_LONG & 0xff), n_1, n_2);
      break;
    case 0x0b:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_B_LONG & 0xff), n_1, n_2);
      break;
    case 0x0c:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_C_LONG & 0xff), n_1, n_2);
      break;
    case 0x0d:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_D_LONG & 0xff), n_1, n_2);
      break;
    case 0x0e:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_E_LONG & 0xff), n_1, n_2);
      break;
    case 0x0f:
      multosBlockShiftRight(GCD_MAX_SIZE_2*2, (N_BITS_F_LONG & 0xff), n_1, n_2);
      break;
  }

  Copy(GCD_MAX_SIZE_2*2, input_2, n_2);
}
...
void gcd_lehmer(unsigned char *n1, unsigned char *n2, unsigned char *r)
{
  unsigned char a[GCD_MAX_SIZE_2]; 
  unsigned char b[GCD_MAX_SIZE_2]; 
...
//  Copy(GCD_MAX_SIZE_2, public.apdu.data, tmp_3); 
}


void gcd_lehmer_long(unsigned char *n1, unsigned char *n2, unsigned char *r)
{
  unsigned char a[GCD_MAX_SIZE_2*2]; 
  unsigned char b[GCD_MAX_SIZE_2*2]; 

  unsigned char x[GCD_MAX_SIZE_2*2]; 
  unsigned char y[GCD_MAX_SIZE_2*2]; 
  ...
  Copy(GCD_MAX_SIZE_2*2, a, n1);
  Copy(GCD_MAX_SIZE_2*2, b, n2);
...
//      break;
    ...
    Copy(GCD_MAX_SIZE_2*2, public.apdu.data, x);
