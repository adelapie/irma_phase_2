...
void constructProof(unsigned char *masterSecret) {
  ...
  ModExp(SIZE_M, SIZE_N, credential_1->attribute[0], credential_1->issuerKey.n, credential_1->issuerKey.Z, public.prove.buffer.number[1]);          
  ModExp(SIZE_M, SIZE_N, r1, credential_1->issuerKey.n, credential_1->issuerKey.S, public.prove.buffer.number[1]);          
  ...
  ComputeHat();
  ModExp(SIZE_M_, SIZE_N, session.prove.mHatTemp, credential_1->issuerKey.n, credential_1->issuerKey.Z, public.prove.buffer.number[0]);          

  ComputeHat();
  ModExp(SIZE_M_, SIZE_N, session.prove.mHatTemp, credential_1->issuerKey.n, credential_1->issuerKey.S, public.prove.buffer.number[1]);          
  ...
  ModExp(SIZE_M, SIZE_N, credential_2->attribute[0], credential_2->issuerKey.n, credential_2->issuerKey.Z, public.prove.buffer.number[1]);          
  ModExp(SIZE_M, SIZE_N, r1, credential_2->issuerKey.n, credential_2->issuerKey.S, public.prove.buffer.number[1]);          
  ...
  ComputeHat();
  ModExp(SIZE_M_, SIZE_N, session.prove.mHatTemp, credential_2->issuerKey.n, credential_2->issuerKey.Z, public.prove.buffer.number[0]);          

  ComputeHat();
  ModExp(SIZE_M_, SIZE_N, session.prove.mHatTemp, credential_2->issuerKey.n, credential_2->issuerKey.S, public.prove.buffer.number[1]);          
