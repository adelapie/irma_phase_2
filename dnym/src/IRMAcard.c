...
/* Bases and exponents for proving the ownership of domain pseudonyms in combination with
   standard pseudonyms. */
  ...
  // All other verification commands
    ...
    switch (INS) {
      ...
      case INS_PROVE_ATTRIBUTE:
        ...
        /* This commitment corresponds to Rdom^ms i.e. dNym */
        ...
        /* This commitment corresponds to nym =  Ro^ms * Rr^r1 */
        ...
        /* Computation of the \hat{r} s-value */
