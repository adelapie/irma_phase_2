  ...
  // All other verification commands
    ...
    switch (INS) {
      ...
      case INS_PROVE_SIGNATURE:
        ...
        switch(P1) {
          ...
          case P1_SIGNATURE_V:
            ...
            Copy(SIZE_V_, public.apdu.data, session.prove.mHatTemp);
            APDU_returnLa(SIZE_V_);

          case P1_SIGNATURE_V_2:
            debugMessage("P1_SIGNATURE_V");
            if (!(APDU_wrapped || CheckCase(1))) {
              APDU_returnSW(SW_WRONG_LENGTH);
            }
      ...
      case INS_PROVE_ATTRIBUTE:
        ...
        if (P2 == 0x00)        
          gen_attr_1(&credentials[0], P1, masterSecret);
        else
          gen_attr_2(&credentials[1], P1, masterSecret);
