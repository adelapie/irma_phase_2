...
/* Weierstrass parameters of different ECs for
   performing terminal verification in the IRMA
   card */

/* NOTE: Several parameters were adopted from
   the RELIC Toolkit (http://code.google.com/p/relic-toolkit/)
*/ 
...
/* ECDSA signature and keys utilized in the prototypes */
